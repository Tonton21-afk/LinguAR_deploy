  ...
  Future<void> _fetchGif(String phrase) async {
    ...
    switch (phrase) {
      case "Asul":
        ...
        publicId = "LinguaAR/Gulmatico/colorsandshapes/asul";
        break;
      case "Itim":
        imageUrl =
            "https://res.cloudinary.com/dqthtm7gt/image/upload/v1739467811/LinguaAR/Anthony/Relasyon/Valentines-card.gif";
        publicId = "LinguaAR/Gulmatico/colorsandshapes/itim";
        break;
      case "Kayumanggi":
        imageUrl =
            "https://res.cloudinary.com/dqthtm7gt/image/upload/v1739467846/LinguaAR/Anthony/Relasyon/Valentines-day.gif";
        publicId = "LinguaAR/Gulmatico/colorsandshapes/kayumanggi";
        break;
      case "Rosas":
        imageUrl =
            "https://res.cloudinary.com/dqthtm7gt/image/upload/v1739467884/LinguaAR/Anthony/Relasyon/Bulaklak.gif";
        publicId = "LinguaAR/Gulmatico/colorsandshapes/rosas";
        break;
      case "Kahel":
        imageUrl =
            "https://res.cloudinary.com/dqthtm7gt/image/upload/v1739467903/LinguaAR/Anthony/Relasyon/Halik.gif";
        publicId = "LinguaAR/Gulmatico/colorsandshapes/kahel";
        break;
      case "Abo":
        imageUrl =
            "https://res.cloudinary.com/dqthtm7gt/image/upload/v1739467903/LinguaAR/Anthony/Relasyon/Halik.gif";
        publicId = "LinguaAR/Gulmatico/colorsandshapes/abo";
        break;
      case "Berde":
        imageUrl =
            "https://res.cloudinary.com/dqthtm7gt/image/upload/v1739467903/LinguaAR/Anthony/Relasyon/Halik.gif";
        publicId = "LinguaAR/Gulmatico/colorsandshapes/berde";
        break;
      case "Ginto":
        imageUrl =
            "https://res.cloudinary.com/dqthtm7gt/image/upload/v1739467903/LinguaAR/Anthony/Relasyon/Halik.gif";
        publicId = "LinguaAR/Gulmatico/colorsandshapes/ginto";
        break;
      case "Paresukat":
        imageUrl =
            "https://res.cloudinary.com/dqthtm7gt/image/upload/v1739467903/LinguaAR/Anthony/Relasyon/Halik.gif";
        publicId = "LinguaAR/Gulmatico/colorsandshapes/paresukat";
        break;
      case "Bilog":
        imageUrl =
            "https://res.cloudinary.com/dqthtm7gt/image/upload/v1739467903/LinguaAR/Anthony/Relasyon/Halik.gif";
        publicId = "LinguaAR/Gulmatico/colorsandshapes/bilog";
        break;
      default:
        setState(() {
          _isLoading = false;
