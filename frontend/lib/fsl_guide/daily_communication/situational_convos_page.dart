...
class SituationalConvosPage extends StatefulWidget {
  @override
  State<SituationalConvosPage> createState() => _SituationalConvosPageState();
}

class _SituationalConvosPageState extends State<SituationalConvosPage> {
  String _gifUrl = '';
