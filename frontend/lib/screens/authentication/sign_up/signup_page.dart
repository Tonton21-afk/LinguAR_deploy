...
class _SignUpPageState extends State<SignUpPage> {
  ...
  String? emailError;
  String? selectedDisability; // For storing selected disability

  bool _obscurePassword = true;
  bool _obscureConfirmPassword = true;

  // List of disability options
                          ...
                          children: [
                            Text(
                              ...
                              DropdownButtonFormField<String>(
                                ...
                                items: disabilityOptions.map((String value) {
                              ...
                              SizedBox(
                                ...
                                child: ElevatedButton(
                                  onPressed: () {
                                    ...
                                    // If all validations pass, trigger the registration
                                    if (emailError == null &&
                                        passwordError == null &&
                                        confirmPasswordError == null) {
                                      showDialog(
