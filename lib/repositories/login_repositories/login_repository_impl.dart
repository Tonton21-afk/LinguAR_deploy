...
class LoginRepositoryImpl implements LoginRepository {
  final String apiUrl = 'http://127.0.0.1:5000/login'; // Correct the endpoint as needed
  ...
  Future<Authentication> login(String email, String password) async {
    ...
    if (response.statusCode == 200) {
      ...
      return Authentication.fromJson(responseData);  // Return the full Authentication object
